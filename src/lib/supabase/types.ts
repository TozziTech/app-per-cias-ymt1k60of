...
//   $function$
//
// FUNCTION generate_contato_codigo_id()
...
// --- TRIGGERS ---
// Table: contatos
//   set_contato_codigo_id: CREATE TRIGGER set_contato_codigo_id BEFORE INSERT ON public.contatos FOR EACH ROW EXECUTE FUNCTION generate_contato_codigo_id()
// Table: lancamentos
